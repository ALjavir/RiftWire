...
function instrumentHandler(handler, fns) {
	...
	if (aggregated.request.length > 0) instrumentedHandler = async (...args) => {
		...
		return throwOrReturnResult(await recurseRight(aggregated.request, {
			...
			invariant$1(result.value instanceof Response, "Expected a Response from the request handler");
			return {
				...getInstrumentationInnerResult(result),
...
//#endregion
export { Await as $, isRedirectResponse as $t, setIsHydrated as A, parsePath as An, useNavigation as At, shouldHydrateRouteLoader as B, ViewTransitionContext as Bn, useRouterState as Bt, createSearchParams as C, stripBasename as Cn, useHref as Ct, Meta as D, createMemoryHistory as Dn, useMatch as Dt, Links as E, createHashHistory as En, useLocation as Et, useFogOFWarDiscovery as F, FetchersContext as Fn, useResolvedPath as Ft, decodeViaTurboStream as G, IDLE_FETCHER as Gt, NO_BODY_STATUS_CODES as H, decodeRedirectErrorDigest as Ht, createClientRoutes as I, LocationContext as In, useRevalidator as It, singleFetchUrl as J, createStaticHandler as Jt, getSingleFetchDataStrategyImpl as K, IDLE_NAVIGATION as Kt, createClientRoutesWithHMRRevalidationOptOut as L, NavigationContext as Ln, useRoute as Lt, getPatchRoutesOnNavigationFunction as M, AwaitContextProvider as Mn, useOutlet as Mt, getPathsWithAncestors as N, DataRouterContext as Nn, useOutletContext as Nt, PrefetchPageLinks as O, createPath as On, useMatches as Ot, handleClientVersionMismatch as P, DataRouterStateContext as Pn, useParams as Pt, escapeHtml as Q, isMutationMethod as Qt, createServerRoutes as R, RSCRouterContext as Rn, useRouteError as Rt, useViewTransitionState as S, resolvePath as Sn, useBlocker as St, FrameworkContext as T, createBrowserHistory as Tn, useLoaderData as Tt, SingleFetchRedirectSymbol as U, decodeRouteErrorResponseDigest as Ut, RemixErrorBoundary as V, useRoutes as Vt, StreamTransfer as W, IDLE_BLOCKER as Wt, createRequestInit as X, hasInvalidProtocol as Xt, stripIndexParam as Y, getStaticContextFromError as Yt, encode as Z, isDataWithResponseInit as Zt, useLinkClickHandler as _, matchRoutesImpl as _n, withHydrateFallbackProps as _t, Form as a, RouterContextProvider as an, RouterProvider as at, useSearchParams as b, removeTrailingSlash as bn, useAsyncError as bt, Link as c, createDataFunctionUrl as cn, WithErrorBoundaryProps as ct, createBrowserRouter as d, encodePathParam as dn, createRoutesFromChildren as dt, isRedirectStatusCode as en, MemoryRouter as et, createHashRouter as f, generatePath as fn, createRoutesFromElements as ft, useFormAction as g, matchRoutes as gn, withErrorBoundaryProps as gt, useFetchers as h, matchPath as hn, withComponentProps as ht, BrowserRouter as i, ErrorResponseImpl as in, Router as it, getManifestPath as j, PROTOCOL_RELATIVE_URL_REGEX as jn, useNavigationType as jt, Scripts as k, invariant$1 as kn, useNavigate as kt, NavLink as l, data as ln, WithHydrateFallbackProps as lt, useFetcher as m, isRouteErrorResponse as mn, renderMatches as mt, StaticRouterProvider as n, instrumentHandler as nn, Outlet as nt, HashRouter as o, convertRoutesToDataRoutes as on, Routes as ot, useBeforeUnload as p, getRoutePattern as pn, hydrationRouteProperties as pt, getTurboStreamSingleFetchDataStrategy as q, createRouter as qt, createStaticRouter as r, instrumentationResultMetaContext as rn, Route as rt, HistoryRouter as s, createContext as sn, WithComponentProps as st, StaticRouter as t, isResponse as tn, Navigate as tt, ScrollRestoration as u, defaultMapRouteProperties as un, createMemoryRouter as ut, usePrompt as v, redirect as vn, warnOnce as vt, CRITICAL_CSS_DATA_ATTRIBUTE as w, Action as wn, useInRouterContext as wt, useSubmit as x, replace as xn, useAsyncValue as xt, useScrollRestoration as y, redirectDocument as yn, useActionData as yt, noActionDefinedError as z, RouteContext as zn, useRouteLoaderData as zt };
